...
const byte start_power = 10;                      //Start power for transmissions
...
unsigned int ModeStartDelaymS = 1000;             //delay in mS after sending mode change at start of loop, gives RX time to print packet totals.
const unsigned int mode_delaymS = 1000;           //mS delay between modes
const unsigned int packet_delay = 250;            //mS delay between packets
